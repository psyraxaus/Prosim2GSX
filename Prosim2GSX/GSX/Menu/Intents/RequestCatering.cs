...
{
    /// <summary>
    /// Gate-menu service intent: request GSX catering service.
    /// </summary>
    internal sealed class RequestCatering : KeywordIntent
    {
        public RequestCatering()
            : base(@"(?i)^request catering")
        { }
        ...
        public override string Describe() => "Request GSX catering service";
    }
}
