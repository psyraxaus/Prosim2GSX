...
export function AircraftProfilesPanel() {
    ...
    const hasAircraftInfo = !!list.currentAirline || !!list.currentTitle;
    return (_jsxs("div", { className: styles.panel, children: [_jsxs("div", { className: styles.toolbar, children: [_jsxs("span", { className: styles.activeName, children: ["Active: ", _jsx("strong", { children: list.activeName || "—" })] }), _jsxs("div", { className: styles.toolbarStatus, children: [error && _jsx("span", { className: styles.error, children: error }), info && _jsx("span", { className: styles.info, children: info })] })] }), _jsxs(Section, { title: "Current Aircraft", hint: hasAircraftInfo ? "" : "Sim not connected — profile matching will use defaults", children: [_jsxs("div", { className: styles.kv, children: [_jsx("span", { className: styles.kvLabel, children: "Airline" }), _jsx("span", { className: styles.kvValue, children: list.currentAirline || "—" })] }), _jsxs("div", { className: styles.kv, children: [_jsx("span", { className: styles.kvLabel, children: "Title / Livery" }), _jsx("span", { className: styles.kvValue, children: list.currentTitle || "—" })] }), _jsxs("div", { className: styles.kv, children: [_jsx("span", { className: styles.kvLabel, children: "Active Profile" }), _jsx("span", { className: styles.kvValue, children: _jsx("strong", { children: list.activeName || "—" }) })] })] }), _jsxs(Section, { title: "Profiles", hint: "Profiles are matched in this order: Title \u2192 Airline \u2192 Default fallback", children: [list.profiles.length === 0 && (_jsx("div", { className: styles.empty, children: "No profiles configured." })), _jsx("div", { className: styles.profileList, children: list.profiles.map((p) => {
