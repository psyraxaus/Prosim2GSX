...
export function FlightStatusPanel() {
    ...
    return (_jsxs("div", { className: styles.panel, children: [_jsxs(Section, { title: "Sim", children: [_jsx(Indicator, { label: "Sim Running", ok: fs.simRunning }), _jsx(Indicator, { label: "Sim Connected", ok: fs.simConnected }), _jsx(Indicator, { label: "Sim Session", ok: fs.simSession }), _jsx(Indicator, { label: "Sim Paused", ok: !fs.simPaused, reverseLabel: "Paused" }), _jsx(Indicator, { label: "Walkaround", ok: !fs.simWalkaround, reverseLabel: "Active" }), _jsx(KV, { label: "Camera State", value: String(fs.cameraState) }), _jsx(KV, { label: "Sim Version", value: fs.simVersion || "—" }), _jsx(KV, { label: "Aircraft", value: fs.aircraftString || "—" })] }), _jsxs(Section, { title: "App", children: [_jsx(Indicator, { label: "GSX Controller", ok: fs.appGsxController }), _jsx(Indicator, { label: "Aircraft Binary", ok: fs.appAircraftBinary }), _jsx(Indicator, { label: "Aircraft Interface", ok: fs.appAircraftInterface }), _jsx(Indicator, { label: "ProSim Connected", ok: fs.appProsimConnected }), _jsx(Indicator, { label: "ProSim SDK Connected", ok: fs.appProsimSdkConnected }), _jsx(Indicator, { label: "Automation Controller", ok: fs.appAutomationController }), _jsx(Indicator, { label: "Audio Controller", ok: fs.appAudioController }), _jsx(KV, { label: "Profile", value: fs.appProfile || "—" }), _jsx(KV, { label: "Aircraft", value: fs.appAircraft }), _jsx(KV, { label: "On Ground", value: String(fs.appOnGround) }), _jsx(KV, { label: "Engines Running", value: String(fs.appEnginesRunning) }), _jsx(KV, { label: "In Motion", value: String(fs.appInMotion) })] }), _jsxs(Section, { title: "GSX", children: [_jsx(Indicator, { label: "GSX Running", ok: fs.gsx.gsxRunning }), _jsx(Indicator, { label: "Couatl Vars", ok: fs.gsx.gsxStartedValid }), _jsx(KV, { label: "Couatl Started", value: fs.gsx.gsxStarted }), _jsx(KV, { label: "Menu State", value: fs.gsx.gsxMenu }), _jsx(KV, { label: "Pax Target", value: String(fs.gsx.gsxPaxTarget) }), _jsx(KV, { label: "Pax Total (B|D)", value: fs.gsx.gsxPaxTotal }), _jsx(KV, { label: "Cargo (B|D)", value: fs.gsx.gsxCargoProgress }), _jsx(KV, { label: "Phase", value: fs.gsx.appAutomationState }), _jsx(KV, { label: "Departure Services", value: fs.gsx.appAutomationDepartureServices })] }), _jsxs(Section, { title: "Services", children: [_jsx(ServiceRow, { label: "Reposition", state: fs.gsx.serviceReposition }), _jsx(ServiceRow, { label: "Refuel", state: fs.gsx.serviceRefuel }), _jsx(ServiceRow, { label: "Catering", state: fs.gsx.serviceCatering }), _jsx(ServiceRow, { label: "Lavatory", state: fs.gsx.serviceLavatory }), _jsx(ServiceRow, { label: "Water", state: fs.gsx.serviceWater }), _jsx(ServiceRow, { label: "Cleaning", state: fs.gsx.serviceCleaning }), _jsx(GpuRow, { connected: fs.gsx.serviceGpuConnected, relevant: fs.gsx.serviceGpuPhaseRelevant }), _jsx(ServiceRow, { label: "Boarding", state: fs.gsx.serviceBoarding }), _jsx(ServiceRow, { label: "Deboarding", state: fs.gsx.serviceDeboarding }), _jsx(KV, { label: "Pushback", value: fs.gsx.servicePushback }), _jsx(ServiceRow, { label: "Jetway", state: fs.gsx.serviceJetway }), _jsx(ServiceRow, { label: "Stairs", state: fs.gsx.serviceStairs })] }), _jsx(Section, { title: "Log", children: _jsx(LogTail, { messages: fs.messageLog }) })] }));
}
