...
function ChecklistRow({ item, isCurrent, allowOverride, onClick }) {
    ...
    if (item.isChecked) {
        return (_jsxs("div", { className: `${styles.itemRow} ${styles.checked} ${clickable ? styles.clickable : ""}`, onClick: clickable ? onClick : undefined, role: clickable ? "button" : undefined, children: [_jsx("span", { className: styles.itemCheck, children: "\u2713" }), _jsx("span", { children: item.label }), _jsx("span", { className: styles.itemDots, children: "...................................................................................................." }), _jsx("span", { children: item.value })] }));
    }
    if (isCurrent) {
        return (_jsxs("div", { className: `${styles.itemRow} ${styles.pending} ${styles.current} ${clickable ? styles.clickable : ""}`, onClick: clickable ? onClick : undefined, role: clickable ? "button" : undefined, children: [_jsx("span", { className: styles.itemCheck, children: "\u25A1" }), _jsx("span", { children: item.label }), _jsx("span", { className: styles.itemDots, children: "...................................................................................................." }), _jsx("span", { children: item.value })] }));
    }
