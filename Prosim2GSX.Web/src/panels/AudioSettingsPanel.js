...
export function AudioSettingsPanel() {
    ...
    function setStartupVolume(channel, raw) {
    ...
    function toggleStartupUnmute(channel, value) {
        setDraft((d) => {
            if (!d)
                return d;
